                        ...
                        <table width="100%">
                            <tbody>
                                ...
                                <tr class='cent'>
                                    ...
                                    <td><input type="text" name="name[]" value="<?=$row['name'];?>" style='width:30%'> </td>
                                    <td><input type="text" name="href[]" value="<?=$row['href'];?>" style='width:30%'> </td>
                            ...
                            <tbody>
                                <tr>
                                    <td width="200px"><input type="button"
                                            onclick="op('#cover','#cvr','modal/menu.php?table=<?=$table;?>')"
                                            value="新增主選單"></td>
